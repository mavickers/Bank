...
namespace Tests.RegistrationStrategies
{
    public class ViteReactLib
    {
        ...
        public void Basic()
        {
            ...
            var assets = new LightPath.Bank.RegistrationStrategies.ViteReactLibStrategy(assembly, "StrategyTestAssets.ViteReactLibStrategy.ClientApp.dist", "manifest.json", "ClientApp");
